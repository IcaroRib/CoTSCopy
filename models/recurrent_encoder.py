...
class CoSTRnnEncoder(nn.Module):
    def __init__(self, input_dims, output_dims,
        ...
        self.feature_extractor = DilatedRecurrentEncoder(hidden_dims, output_dims)
        ...
        self.tfd = nn.ModuleList(
            [nn.RNN(output_dims, component_dims, 1, False) for k in kernels]
        )
